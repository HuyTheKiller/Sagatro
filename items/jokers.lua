...
local drink_me = {
    ...
    attributes = {"food", "modify_card", "position"},
    rarity = 1,
    cost = 6,
...
local mouse = {
    ...
    attributes = {"mult", "passive", "debuff"},
    rarity = 1,
    cost = 5,
    blueprint_compat = true,
    demicoloncompat = true,
...
local kid_gloves_and_fan = {
    ...
    attributes = {"modify_card", "position", "destroy_card"},
    rarity = 2,
    cost = 8,
    blueprint_compat = false,
    demicoloncompat = false,
...
local huge_dog = {
    ...
    attributes = {"retrigger", "rank", "ace", "two"},
    rarity = 2,
    cost = 6,
    blueprint_compat = true,
    demicoloncompat = false,
...
local pigeon = {
    ...
    attributes = {"sell_value", "scaling", "economy", "generation"},
    rarity = 2,
    cost = 8,
    blueprint_compat = false,
    demicoloncompat = true,
...
local frog_footman = {
    ...
    attributes = {"consumable_slot", "tarot", "planet", "spectral", "generation"},
    rarity = 1,
    cost = 5,
    blueprint_compat = false,
    demicoloncompat = true,
...
local duchess = {
    ...
    attributes = {"emult", "face", "destroy_card", "chance"},
    rarity = "sgt_obscure",
    cost = 12,
    blueprint_compat = true,
    demicoloncompat = true,
...
local mad_hatter = {
    ...
    attributes = {"modify_ante", "modify_weight"},
    rarity = "sgt_obscure",
    cost = 16,
    blueprint_compat = false,
    demicoloncompat = false,
...
local shepherd_boy = {
    ...
    order = 990,
    pools = { [SAGA_GROUP_POOL.misc] = true },
    pos = { x = 0, y = 0 },
    config = {extra = {mult = 0, mult_mod = 12, odds = 6}},
    attributes = {"mult", "reset", "destroy_card", "chance"},
    rarity = 1,
    cost = 5,
    blueprint_compat = true,
    demicoloncompat = true,
...
local puss_in_boots = {
    ...
    attributes = {"xmult", "economy", "rank", "jack", "queen", "king"},
    rarity = 2,
    cost = 7,
    blueprint_compat = true,
    demicoloncompat = true,
...
local lamp_genie = {
    ...
    attributes = {"economy", "joker_slot", "consumable_slot", "hand_size", "retrigger", "boss_blind", "editions", "emult"},
    rarity = "sgt_esoteric",
    cost = 50,
    blueprint_compat = true,
    demicoloncompat = true,
...
local submarine = {
    ...
    attributes = {"joker_slot", "consumable_slot", "hand_size"},
    rarity = "sgt_obscure",
    cost = 14,
    blueprint_compat = false,
    demicoloncompat = false,
...
local prawn = {
    ...
    attributes = {"economy", "suit", "diamonds"},
    rarity = 1,
    cost = 5,
    blueprint_compat = true,
    demicoloncompat = true,
...
local john_dory = {
    ...
    attributes = {"retrigger", "economy", "rank", "jack", "suit", "diamonds"},
    rarity = 3,
    cost = 8,
    blueprint_compat = true,
    demicoloncompat = true,
...
local turtle_egg = {
    ...
    attributes = {"chance", "sell_value", "scaling", "economy"},
    rarity = 1,
    cost = 4,
    blueprint_compat = false,
    demicoloncompat = true,
...
local baby_turtle = {
    ...
    attributes = {"xmult", "rank", "three", "seven", "nine"},
    rarity = 1,
    cost = 5,
    blueprint_compat = true,
    demicoloncompat = true,
...
local stonefish = {
    ...
    attributes = {"modify_card", "enhancements", "face"},
    rarity = 2,
    cost = 6,
    blueprint_compat = false,
    demicoloncompat = true,
...
local coral_kingdom = {
    ...
    attributes = {"chips", "scaling", "enhancements", "generation"},
    rarity = 2,
    cost = 7,
    blueprint_compat = true,
    demicoloncompat = true,
...
local dolphin = {
    ...
    attributes = {"xmult", "enhancements", "scaling"},
    rarity = 2,
    cost = 6,
...
local coelacanthiformes = {
    ...
    attributes = {"destroy_card", "rank", "four", "generation"},
    rarity = 3,
    cost = 7,
    blueprint_compat = false,
    demicoloncompat = true,
...
local sunfish = {
    ...
    attributes = {"suit", "hearts", "diamonds", "passive"},
    rarity = 1,
    cost = 4,
    blueprint_compat = false,
    demicoloncompat = false,
...
local moonfish = {
    ...
    attributes = {"suit", "spades", "clubs", "passive"},
    rarity = 1,
    cost = 4,
    blueprint_compat = false,
    demicoloncompat = false,
...
local penguin = {
    ...
    attributes = {"retrigger", "hands", "discards"},
    rarity = 1,
    cost = 5,
    blueprint_compat = true,
    demicoloncompat = false,
...
local ray = {
    ...
    attributes = {"mult", "reset", "scaling", "rank"},
    rarity = 2,
    cost = 7,
    blueprint_compat = true,
    demicoloncompat = true,
...
local starfish = {
    ...
    attributes = {"chips", "rank", "five", "full_deck"},
    rarity = 1,
    cost = 4,
    blueprint_compat = true,
    demicoloncompat = true,
...
local nautilus = {
    ...
    attributes = {"retrigger", "rank", "ace", "two", "three", "five", "eight", "king"},
    rarity = "sgt_obscure",
    cost = 14,
    blueprint_compat = true,
    demicoloncompat = false,
...
local stomiidae = {
    ...
    attributes = {"xmult", "scaling", "suit", "spades", "modify_card", "destroy_card"},
    rarity = "sgt_obscure",
    cost = 14,
    blueprint_compat = true,
    demicoloncompat = true,
...
local big_red_jelly = {
    ...
    attributes = {"xmult", "scaling", "suit", "hearts"},
    rarity = 3,
    cost = 8,
    blueprint_compat = true,
    demicoloncompat = true,
...
local seahorse = {
    ...
    attributes = {"rank", "eight", "generation", "chance"},
    rarity = 1,
    cost = 5,
    blueprint_compat = true,
    demicoloncompat = true,
...
local goblin_shark = {
    ...
    attributes = {"economy", "scaling", "destroy_card"},
    rarity = 3,
    cost = 9,
    blueprint_compat = false,
    demicoloncompat = true,
...
local colossal_squid = {
    ...
    attributes = {"retrigger", "rank", "ten", "jack", "queen", "king", "ace"},
    rarity = 3,
    cost = 10,
    blueprint_compat = true,
    demicoloncompat = false,
...
local chimaera = {
    ...
    attributes = {"scaling", "destroy_card", "spectral", "generation"},
    rarity = 3,
    cost = 8,
    blueprint_compat = false,
    demicoloncompat = true,
...
local dumbo_octopus = {
    ...
    attributes = {"retrigger", "rank", "eight", "suit", "diamonds"},
    rarity = 3,
    cost = 8,
    blueprint_compat = true,
    demicoloncompat = false,
...
local atolla_wyvillei = {
    ...
    attributes = {"modify_weight", "xmult"},
    rarity = 3,
    cost = 10,
    blueprint_compat = true,
    demicoloncompat = true,
...
local brittle_star = {
    ...
    attributes = {"xmult", "destroy_card", "chance"},
    rarity = 3,
    cost = 9,
    blueprint_compat = true,
    demicoloncompat = true,
    ...
    calculate = function(self, card, context)
        ...
        and SMODS.pseudorandom_probability(card, 'brittle_cards', 1, card.ability.extra.odds, "brittle_star") then
            context.destroy_card.ability.shatters_on_destroy = true
            return {remove = true}
        end
    end,
    in_pool = function(self, args)
...
local comb_jellyfish = {
    ...
    attributes = {"suit", "spectral", "generation"},
    rarity = 3,
    cost = 8,
    blueprint_compat = false,
    demicoloncompat = true,
...
local lobster = {
    ...
    attributes = {"retrigger", "suit", "diamonds"},
    rarity = 2,
    cost = 6,
    blueprint_compat = true,
    demicoloncompat = false,
...
local white_pawn = {
    ...
    attributes = {"hand_type", "destroy_card", "suit", "spades", "clubs", "hearts", "diamonds"},
    rarity = 1,
    cost = 3,
    blueprint_compat = false,
    demicoloncompat = false,
...
local white_queen = {
    ...
    attributes = {"mult", "rank", "queen", "suit", "spades", "clubs", "hearts", "diamonds"},
    rarity = 2,
    cost = 7,
    blueprint_compat = true,
    demicoloncompat = true,
    ...
    calculate = function(self, card, context)
        ...
        if context.joker_main then
            ...
            for _, v in ipairs(G.hand.cards) do
                ...
                elseif v:is_suit("Hearts", true) or v:is_suit("Diamonds", true) then
                    hearts_diamonds = hearts_diamonds + 1
                end
            end
    ...
    joker_display_def = function(JokerDisplay)
        return {
            ...
            calc_function = function(card)
                ...
                for _, playing_card in ipairs(G.hand.cards) do
                    if playing_hand or not playing_card.highlighted then
                        if playing_card.facing and not (playing_card.facing == 'back') then
                            if playing_card:get_id() == 12 and not playing_card.debuff then
                                count = count + JokerDisplay.calculate_card_triggers(playing_card, nil, true)
                            end
                            if playing_card:is_suit("Spades", true) or playing_card:is_suit("Clubs", true) then
                                spades_clubs = spades_clubs + 1
                            elseif playing_card:is_suit("Hearts", true) or playing_card:is_suit("Diamonds", true) then
                                hearts_diamonds = hearts_diamonds + 1
                            end
                        end
                    end
...
local white_king = {
    ...
    attributes = {"xmult", "rank", "queen", "suit", "spades", "clubs", "hearts", "diamonds"},
    rarity = 3,
    cost = 10,
    blueprint_compat = true,
    demicoloncompat = true,
...
local man_in_white = {
    ...
    attributes = {"mult", "scaling", "hand_type", "xmult"},
    rarity = 2,
    cost = 6,
    blueprint_compat = true,
    demicoloncompat = true,
...
local dinah = {
    ...
    attributes = {"emult", "scaling", "destroy_card"},
    rarity = "sgt_obscure",
    cost = 14,
    blueprint_compat = true,
    demicoloncompat = true,
...
local tweedledum = {
    ...
    attributes = {"xchips", "xmult", "rank", "ace", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten"},
    rarity = 2,
    cost = 6,
    blueprint_compat = true,
    demicoloncompat = true,
...
local white_rook = {
    ...
    pools = { [SAGA_GROUP_POOL.alice_m] = true },
    config = {extra = {mult = 3}},
    attributes = {"hand_type", "passive", "suit", "spades", "clubs", "hearts", "diamonds"},
    rarity = 2,
    cost = 7,
    blueprint_compat = true,
    demicoloncompat = true,
...
local white_knight = {
    ...
    pools = { [SAGA_GROUP_POOL.alice_m] = true },
    config = {extra = {mult = 3}},
    attributes = {"passive", "suit", "spades", "clubs", "hearts", "diamonds"},
    rarity = 2,
    cost = 8,
    blueprint_compat = true,
    demicoloncompat = true,
...
local jubjub_bird = {
    ...
    pools = { [SAGA_GROUP_POOL.alice_m] = true },
    config = {value_loss = 3},
    attributes = {"modify_ante", "boss_blind", "sell_value"},
    rarity = "sgt_obscure",
    cost = 12,
    blueprint_compat = false,
    demicoloncompat = false,
...
local humpty_dumpty = {
    ...
    attributes = {"rank", "sell_value", "scaling", "economy"},
    rarity = 1,
    cost = 5,
    blueprint_compat = false,
    demicoloncompat = true,
    ...
    loc_vars = function(self, info_queue, card)
        ...
        or (G.STAGE == G.STAGES.MAIN_MENU and Sagatro.config.DisableOtherJokers) or card.displaying_save then
...
local unicorn = {
    ...
    attributes = {"skip", "passive", "economy"},
    rarity = 3,
    cost = 7,
    blueprint_compat = false,
    demicoloncompat = false,
...
local true_red_queen = {
    ...
    attributes = {"emult", "hand_type", "suit", "hearts", "diamonds"},
    rarity = "sgt_obscure",
    cost = 16,
    blueprint_compat = true,
    demicoloncompat = true,
...
local knife_fork = {
    ...
    attributes = {"retrigger", "rank", "queen"},
    rarity = 2,
    cost = 6,
    blueprint_compat = true,
    demicoloncompat = false,
...
local rose_bell = {
    ...
    attributes = {"xmult", "scaling", "rank", "queen", "suit", "hearts"},
    rarity = 3,
    cost = 8,
    blueprint_compat = true,
    demicoloncompat = true,
...
local fleta = {
    ...
    attributes = {"xmult", "rank", "queen", "suit", "hearts"},
    rarity = 4,
    cost = 20,
    blueprint_compat = true,
    demicoloncompat = true,
...
local lisette = {
    ...
    attributes = {"xmult", "enhancements", "mod_chance"},
    rarity = 4,
    cost = 20,
    blueprint_compat = true,
    demicoloncompat = true,
...
local rusty_scissors = {
    ...
    pos = { x = 4, y = 6 },
    config = {},
    attributes = {"enhancements", "mod_chance"},
    rarity = 1,
    cost = 3,
    blueprint_compat = false,
    demicoloncompat = false,
...
local ozzy = {
    ...
    attributes = {"shop_slot", "spectral", "modify_weight"},
    rarity = 4,
    cost = 20,
    blueprint_compat = false,
    demicoloncompat = false,
...
local hansels_cheat_dice = {
    ...
    attributes = {"mod_chance", "passive", "modify_ante"},
    rarity = 3,
    cost = 8,
    blueprint_compat = false,
    demicoloncompat = false,
...
local skoll_n_hati = {
    ...
    attributes = {"xmult", "xchips", "destroy_card", "suit", "hearts", "diamonds", "spades", "clubs"},
    rarity = "sgt_obscure",
    cost = 12,
    blueprint_compat = true,
    demicoloncompat = true,
...
local saint_germain = {
    ...
    pos = { x = 4, y = 1 },
    config = {},
    attributes = {"rank", "king", "modify_card", "enhancements"},
    rarity = "sgt_obscure",
    cost = 12,
    blueprint_compat = false,
    demicoloncompat = true,
...
local necronomicon = {
    ...
    attributes = {"hands", "destroy_card", "generation"},
    rarity = 2,
    cost = 6,
    blueprint_compat = false,
    demicoloncompat = true,
...
local frog_prince = {
    ...
    pos = { x = 0, y = 2 },
    config = {},
    attributes = {"passive", "hand_type", "rank", "king", "tarot", "generation"},
    rarity = 2,
    cost = 8,
    blueprint_compat = true,
    demicoloncompat = true,
...
local abducted_cow = {
    ...
    pos = { x = 3, y = 2 },
    config = {extra = {}},
    attributes = {"destroy_card", "enhancements", "generation"},
    rarity = 1,
    cost = 4,
    blueprint_compat = false,
    demicoloncompat = false,
...
local shub = {
    ...
    no_collection = not Sagatro.mod_compat.talisman,
    order = 4000,
    pools = { [SAGA_GROUP_POOL.lcraft] = true, [SAGA_GROUP_POOL.misc] = true },
    pos = { x = 0, y = 2 },
    soul_pos = { x = 2, y = 2, sgt_extra = { x = 1, y = 2 } },
    config = {extra = {e_mult = 1, e_mult_mod = 0.02}},
    attributes = {"emult", "full_deck", "generation"},
    rarity = "sgt_esoteric",
    cost = 50,
    blueprint_compat = true,
    demicoloncompat = true,
...
local ragnarok = {
    ...
    attributes = {"emult", "scaling", "boss_blind"},
    rarity = "sgt_esoteric",
    cost = 50,
    blueprint_compat = true,
    demicoloncompat = true,
...
local yggdrasil = {
    ...
    no_collection = not Sagatro.mod_compat.talisman,
    order = 2001,
    pools = { [SAGA_GROUP_POOL.norse] = true, [SAGA_GROUP_POOL.misc] = true },
    pos = { x = 3, y = 0 },
...
local thor = {
    ...
    no_collection = not Sagatro.mod_compat.talisman,
    order = 2002,
    pools = { [SAGA_GROUP_POOL.norse] = true, [SAGA_GROUP_POOL.ngods] = true, [SAGA_GROUP_POOL.misc] = true },
    pos = { x = 3, y = 1 },
    soul_pos = { x = 5, y = 1, sgt_extra = { x = 4, y = 1 } },
    config = {extra = {e_mult = 1.5}},
    attributes = {"emult", "retrigger", "enhancements"},
    rarity = "sgt_esoteric",
    cost = 50,
    blueprint_compat = true,
    demicoloncompat = true,
...
local three_body = {
    ...
    no_collection = not Sagatro.mod_compat.talisman,
    order = 3000,
    pools = { [SAGA_GROUP_POOL.celestaverse] = true, [SAGA_GROUP_POOL.misc] = true },
    pos = { x = 6, y = 0 },
