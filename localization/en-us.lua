return {
        ...
        Celestara = {
            ...
            c_sgt_valora = {
                ...
                text = {
                    "{S:0.8}({S:0.8,V:1}lvl.#1#{S:0.8}){} Level up",
                    "{C:attention}#2#{} twice",
                    "{C:attention}Resonate{} with {C:attention}#3#{}",
                },
            },
            c_sgt_zephyria = {
                name = "Zephyria",
            ...
            c_sgt_mystara = {
                ...
                text = {
                    ...
                    "{C:attention}#2#{} twice",
                    "{C:attention}Resonate{} with",
                    "{C:attention}#4#{} and {C:attention}#5#{}",
                },
            },
            c_sgt_ceratek = {
                name = "Ceratek",
            ...
            c_sgt_void_hole_effect = {
                text = {
                    "trigger {C:sgt_celestara}Celestara{} effect",
        ...
        ["Saga Tooltip"] = {
            ...
            white_rabbit = {
                text = {
                    ...
                    "{s:0.8}To a dead-end hall, with a door sealed well.",
                    "{s:0.8}A {s:0.8,C:sgt_sagadition}key{s:0.8} on the table, high as a hill,",
            ...
            dodo_bird = {
                text = {
                    "{s:0.8}These creatures are mad, so many, so strange,",
                    "{s:0.8}Is that the {s:0.8,C:sgt_sagadition}White Rabbit{s:0.8}, just out of range?",
                    "{s:0.8}He thinks I'm his maid - poor Mary Ann!",
                    "{s:0.8}Told me to fetch his gloves and his fan…",
            ...
            unlabeled_bottle = {
                text = {
                    ...
                    "{s:0.8}But eat, and you'll swell up absurdly.",
                    "{s:0.8}Yet this {s:0.8,C:sgt_sagadition}strange drink{s:0.8} made me grow suddenly!",
                    "{s:0.8}I must eat something to bring back my size…",
            ...
            huge_dog = {
                text = {
                    "{s:0.8}Goodness! A puppy - so giant, so bold!",
                    "{s:0.8}Or maybe I'm tiny, just three inches old.",
                    "{s:0.8}It bounded with glee - I dodged uncontrolled,",
                    "{s:0.8}Waited till it {s:0.8,C:sgt_sagadition}VANISHED{s:0.8}, beyond the threshold…",
            ...
            caterpillar = {
                text = {
                    ...
                    "{s:0.8}No name, no greeting - quite a rude cue.",
            ...
            mushroom = {
                text = {
                    "{s:0.8}“{s:0.8,C:sgt_sagadition}This mushroom{s:0.8}'s precious - I should save it, though,”",
                    "{s:0.8}But one big {s:0.8,C:sgt_sagadition}bite{s:0.8} - my neck began to grow.",
                    "{s:0.8}I crawled through the brush when a voice yelled low:",
                    "{s:0.8}“A snake! It's here! My eggs will surely go!”",
            ...
            frog_footman = {
                text = {
                    ...
                    "{s:0.8}Their nonsense logic gets in the way!”",
            ...
            cheshire_cat = {
                text = {
                    "{s:0.8}\"We're all mad here - it's just how we are,",
                    "{s:0.8}I'm mad, you're mad - it's not bizarre.\"",
                    "{s:0.8}Stop {s:0.8,C:sgt_sagadition}vanishing{s:0.8}, then popping from afar…",
            ...
            mad_hatter = {
                text = {
                    ...
                    "{s:0.8}Claiming it's full? What a curious case!",
            ...
            red_queen = {
                text = {
                    "{s:0.8}\"Off with his head!\" - she roared mid-play,",
                    "{s:0.8}Swinging a {s:0.8,C:sgt_sagadition}flamingo{s:0.8} like it's croquet.",
                    "{s:0.8}The ball was a hedgehog - it rolled away,",
                    "{s:0.8}While guards bent as hoops in this wild display.",
                    "{s:0.8,C:sgt_sagadition}The King{s:0.8} whispered softly to soothe her mood,",
                    "{s:0.8}I flinched - did I break some royal rule?",
        ...
        Mod = {
            Sagatro = {
                ...
                text = {
                    ...
                    "{s:1.3}Pick a storyline and find your path towards victory.",
                    " ",
    ...
    misc = {
        ...
        dictionary = {
            ...
            ml_sgt_ready = {"Ready"},
            b_sgt_switch = "SWITCH",
            ml_sgt_switch = {"Switch"},
            b_sgt_transform = "TRANSFORM",
            ml_sgt_transform = {"Trans","form"},
            ...
            ph_mismatch_warning = "Warning: version mismatch!",
            sgt_swap = "Swap!",
        ...
        tutorial = {
            ...
            sgt_s_6 = {
                ...
                "want you to know. It's called {C:sgt_sagadition}Save Box{}!",
