return {
    descriptions = {
        ...
        Celestara = {
            ...
            c_sgt_void_hole_effect = {
                text = {
                    "kích hoạt hiệu ứng {C:sgt_celestara}Huyền Thể{}",
        ...
        ["Saga Tooltip"] = {
            ...
            white_rabbit = {
                text = {
                    ...
                    "{s:0.8}Ngõ cụt hiện ra, cửa khóa nhiệm mầu.",
                    "{s:0.8,C:sgt_sagadition}Chìa {s:0.8}đặt trên bàn cao như đỉnh núi,",
            ...
            dodo_bird = {
                text = {
                    "{s:0.8}Lũ thú kỳ quặc, thật quá vô vàn,",
                    "{s:0.8}Kìa {s:0.8,C:sgt_sagadition}Thỏ Trắng{} {s:0.8}đó, có phải nó chăng?",
                    "{s:0.8}Tưởng tôi là hầu gái Mary Ann,",
                    "{s:0.8}Bảo lấy quạt rơi, cả găng nó đang...",
            ...
            unlabeled_bottle = {
                text = {
                    ...
                    "{s:0.8}Ăn vào thì lại phình ra to đờ.",
                    "{s:0.8}Thế mà {s:0.8,C:sgt_sagadition}nước này{s:0.8} khiến to bất ngờ",
                    "{s:0.8}Cần ăn gì đó để thu nhỏ lại",
            ...
            caterpillar = {
                text = {
                    ...
                    "{s:0.8}Không lời giới thiệu, thật là thờ ơ.",
            ...
            mushroom = {
                text = {
                    "{s:0.8}Nấm này quý lắm, chắc nên {s:0.8,C:sgt_sagadition}để dành{s:0.8},",
                    "{s:0.8}Mà {s:0.8,C:sgt_sagadition}lỡ cắn mạnh{s:0.8}, cổ dài loanh quanh.",
                    "{s:0.8}Lách qua lùm rậm, ai đó hét rành:",
                    "{s:0.8}“Rắn! Lại gần là trứng bay tan tành!”",
            ...
            frog_footman = {
                text = {
                    ...
                    "{s:0.8}Lý lẽ kỳ cục, chẳng hiểu được nhanh!\"",
            ...
            cheshire_cat = {
                text = {
                    "{s:0.8}\"Ở đây ai cũng điên thôi mà,",
                    "{s:0.8}Tôi điên, cô cũng chẳng khác chi ta.\"",
                    "{s:0.8}Thôi đừng {s:0.8,C:sgt_sagadition}biến mất{s:0.8} rồi hiện vậy nha…",
            ...
            mad_hatter = {
                text = {
                    ...
                    "{s:0.8}Lại còn bảo hết chỗ - nghe mà chối ngôi.",
            ...
            red_queen = {
                text = {
                    "{s:0.8}“Chặt đầu hắn đi!” - giọng vang kinh hoàng,",
                    "{s:0.8}Bà dùng {s:0.8,C:sgt_sagadition}Hồng Hạc{s:0.8} làm búa đánh chơi.",
                    "{s:0.8,C:sgt_sagadition}Nhà Vua{s:0.8} bên cạnh, khẽ nịnh vài lời,",
                    "{s:0.8}Xoa dịu cơn giận, giữ đầu cho người.",
                    "{s:0.8}Tôi lỡ điều chi, bà trừng mắt rồi…",
                    "{s:0.8}Biết đâu chơi tiếp… sẽ được tha thôi?",
        ...
        Mod = {
            Sagatro = {
                ...
                text = {
                    ...
                    "{s:1.3}Chọn một mạch truyện và tìm con đường đến vinh quang.",
                    " ",
    ...
    misc = {
        achievement_names = {
            ach_sgt_pm_bad_end_1 = "Búp Bê Sứ",
            ach_sgt_pm_bad_end_2 = "Mù Loà",
            ach_sgt_pm_normal_end_1 = "Platinum",
            ach_sgt_pm_normal_end_2 = "Bình Minh",
            ach_sgt_pm_normal_end_3 = "Little Goody Two Shoes",
            ach_sgt_pm_unknown_end_1 = "Giờ Ma Quỷ",
            ach_sgt_pm_unknown_end_2 = "Ảo Mộng Tan Vỡ",
        },
        ...
        dictionary = {
            ...
            ml_sgt_ready = {"S.sàng"},
            b_sgt_switch = "CHUYỂN",
            ml_sgt_switch = {"Chuyển"},
            b_sgt_transform = "BIẾN ĐỔI",
            ml_sgt_transform = {"Biến","đổi"},
            b_delete_ace = "Huỷ Át",
            ...
            b_load = "Tải",
            b_delete = "Xoá",
            b_saveload_list = "Danh sách lưu/tải",
            b_wipe_all_saves = "Xoá hết bản lưu",
            ...
            ph_mismatch_warning = "Cảnh báo: không trùng khớp phiên bản!",
            sgt_swap = "Tráo!",
            ...
            SGT_lenient_score_desc = {"Giảm độ dữ dội của tăng điểm vô hạn","trong chế độ cốt truyện (Yêu cầu tạo trận mới)"},
            ...
            sgt_savebox_text1 = "Tính năng này cho phép bạn lưu trữ các trận ở chế độ",
            sgt_savebox_text2 = "cốt truyện riêng biệt, tách khỏi trận hiện tại.",
            sgt_savebox_text3 = "Được truyền cảm hửng bới các tựa game RPG yêu cầu",
            sgt_savebox_text4 = "người chơi phải tiếp cận nhiều ending.",
        },
        quips = {
            sgt_good_end1 = {
        ...
        tutorial = {
            ...
            sgt_s_6 = {
                ...
                "muốn anh/chị biết. Nó được gọi là {C:sgt_sagadition}Hộp Lưu{}.",
